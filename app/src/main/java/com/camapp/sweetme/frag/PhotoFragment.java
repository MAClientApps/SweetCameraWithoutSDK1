package com.camapp.sweetme.frag;
...
import com.camapp.sweetme.adapter.PhoneAlbumAdapt;
import com.camapp.sweetme.model.DeviceAlbum;
import com.camapp.sweetme.model.DevicePhoto;
...
public class PhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        return layoutInflater.inflate(R.layout.fragmentsweet_photo, viewGroup, false);
    }
    ...
    private void initView(View view) {
        ...
        albumAdapter = new PhoneAlbumAdapt(getActivity(), phoneAlbums);
        ...
        try {
            ...
            if (query.moveToFirst()) {
                ...
                while (true) {
                    ...
                    DevicePhoto phonePhoto = new DevicePhoto();
                    ...
                    if (albumsNames.contains(string)) {
                        ...
                        while (true) {
                            ...
                            DeviceAlbum phoneAlbum = (DeviceAlbum) it.next();
                        ...
                        DeviceAlbum phoneAlbum2 = new DeviceAlbum();
