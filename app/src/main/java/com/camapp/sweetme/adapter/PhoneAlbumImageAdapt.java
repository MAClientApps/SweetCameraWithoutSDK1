...
import com.camapp.sweetme.act.SweetEditorMain;

import java.util.ArrayList;
import java.util.List;

public class PhoneAlbumImageAdapt extends Adapter<PhoneAlbumImageAdapt.ViewHolder> {
    public Activity activity;
    public List<String> al_album = new ArrayList();

    public PhoneAlbumImageAdapt(Activity activity2, ArrayList<String> arrayList) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                Intent intent = new Intent(activity, SweetEditorMain.class);
                intent.putExtra("imagePath", (String) al_album.get(i));
