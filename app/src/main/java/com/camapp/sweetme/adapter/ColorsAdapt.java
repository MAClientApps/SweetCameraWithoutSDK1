...
import com.camapp.sweetme.otherView.ColorCircleDraw;
...
public class ColorsAdapt extends Adapter<ColorsAdapt.ViewHolder> implements OnClickListener {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rowsweet_item_color, viewGroup, false);
