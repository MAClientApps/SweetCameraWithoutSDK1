...
public class SweetFaceBlurEdit extends SweetBase implements OnTouchListener, OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activitysweet_face_blur_edit);
