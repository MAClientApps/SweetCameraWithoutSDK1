...
import com.camapp.sweetme.frag.PhotoFragment;

import java.util.ArrayList;


public class SweetGalleryList extends FragmentActivity implements OnClickListener {
    private static SweetGalleryList galleryActivity;
    public Activity mContext;
    public TextView tv_title;
    private ImageView iv_close;
    private long mLastClickTime = 0;

    public static SweetGalleryList getGalleryActivity() {
        return galleryActivity;
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(R.layout.activitysweet_gallery_album);
