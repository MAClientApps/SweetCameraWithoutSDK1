...
import com.camapp.sweetme.adapter.MyCreationAdapt;
...
public class SweetMyCreation extends SweetBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activitysweet_creation);
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                if (images != null && !images.isEmpty()) {
                    Intent intent = new Intent().setClass(SweetMyCreation.this, SweetShareImage.class);
