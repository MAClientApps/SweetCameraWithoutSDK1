...
public class SweetShareImage extends SweetBase implements OnClickListener {
...
//    private ImageView btnShareMoreImage;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activitysweet_share_image);
    ...
    private void findView() {
        ...
        btnSharePinterest = (ImageView) findViewById(R.id.btnShareMoreImage);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnMoreApp:
                Intent intent = new Intent(this, SweetMainAct.class);
