...
import com.camapp.sweetme.helper.Constant;
import com.camapp.sweetme.helper.Landmark;
import com.camapp.sweetme.helper.ResizeImages;
import com.camapp.sweetme.remote.SupporterClass;
import com.camapp.sweetme.utilsApp.ScanFileClass;
...
public class SweetEditorMain extends SweetBase implements OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activitysweet_face_edit);
        ...
        try {
            ...
            Toast.makeText(SweetEditorMain.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    ...
    public void openNext() {
        ...
        if (imagePath != null) {
            ...
            Intent intent = new Intent(SweetEditorMain.this, SweetEditLast.class);
    ...
    public void onBackPressed() {
        ...
        try {
            ...
            startActivity(new Intent(this, SweetMainAct.class));
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.layoutBlur:
                activeBlur();
                Intent intent2 = new Intent(this, SweetFaceBlurEdit.class);
            ...
            case R.id.layoutBlush:
                activeBlush();
                Intent intent3 = new Intent(this, SweetLipEdit.class);
            ...
            default:
                switch (id) {
                    case R.id.layoutEyes:
                        activeEyes();
                        Intent intent4 = new Intent(this, SweetEyeEdit.class);
                    ...
                    case R.id.layoutFoundation:
                        activeFoundation();
                        Intent intent5 = new Intent(this, SweetLipEdit.class);
                    ...
                    case R.id.layoutLips:
                        activeLips();
                        Intent intent6 = new Intent(this, SweetLipEdit.class);
                    ...
                    case R.id.layoutWhitten:
                        activeWhitten();
                        Intent intent7 = new Intent(this, SweetWhittenFaceEdit.class);
    ...
    private void activeEyes() {
        ...
        imgEye.setImageResource((R.drawable.eyebag_selected));
        imgLips.setImageResource((R.drawable.ic_lip));
        imgBlush.setImageResource((R.drawable.ic_cheek));
        imgBlur.setImageResource((R.drawable.ic_blur));
        imgWhitten.setImageResource((R.drawable.ic_whitten));
    ...
    private class FaceDetectTask extends AsyncTask<Void, Void, Void> {
        ...
        private FaceDetectTask() {
            progressDialog = new Dialog(SweetEditorMain.this);
        }

        public void onPreExecute() {
            super.onPreExecute();
            progressDialog.setContentView(R.layout.downloadsweet_popup);
        ...
        public Void doInBackground(Void... voidArr) {
            try {
                ...
                for (VisionDetRet visionDetRet : new FaceDet(datFilePath).detect(originalBmp)) {
                    SweetEditorMain.faceRects[0] = visionDetRet.getLeft();
                    SweetEditorMain.faceRects[1] = visionDetRet.getTop();
                    SweetEditorMain.faceRects[2] = visionDetRet.getRight();
                    SweetEditorMain.faceRects[3] = visionDetRet.getBottom();
                    SweetEditorMain.rect.left = SweetEditorMain.faceRects[0];
                    SweetEditorMain.rect.top = SweetEditorMain.faceRects[1];
                    SweetEditorMain.rect.right = SweetEditorMain.faceRects[2];
                    SweetEditorMain.rect.bottom = SweetEditorMain.faceRects[3];
                    ...
                    for (int i = 0; i != faceLandmarks.size(); i++) {
                        ...
                        SweetEditorMain.faceLandmarks.add(new Landmark(pointF, i));
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
