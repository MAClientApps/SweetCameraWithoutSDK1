...
import com.camapp.sweetme.draw.ImgViewTouch;
import com.camapp.sweetme.draw.ImgViewTouchAndDraw;
import com.camapp.sweetme.draw.ImgViewTouchAndDraw.TouchMode;
import com.camapp.sweetme.helper.Constant;
import com.camapp.sweetme.remote.SupporterClass;
import com.camapp.sweetme.utilsApp.GPUImgFilterTool;
...
public class SweetWhittenFaceEdit extends SweetBase implements OnTouchListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activitysweet_whitten_face_edit);
            ...
            whittenTeethDone.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    if (btnOnclick.booleanValue()) {
                        SweetWhittenFaceEdit whittenFaceActivity = SweetWhittenFaceEdit.this;
                        whittenFaceActivity.bitmap = whittenFaceActivity.createFinalImage();
                        SweetWhittenFaceEdit whittenFaceActivity2 = SweetWhittenFaceEdit.this;
...
//                        file = new File(whittenFaceActivity2.saveBitmap(whittenFaceActivity2.bitmap));
                    ...
                    SweetWhittenFaceEdit whittenFaceActivity3 = SweetWhittenFaceEdit.this;
